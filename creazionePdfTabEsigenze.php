<?php 
session_start();
$recapArrayAlimentaz= $_SESSION['recapDatiTabellaAlimentazione'];
$data = $_SESSION['dataAttuale'];
$totale = $_SESSION['conteggioTotaleEsigenze'];


$recapDatiTabellaAliment= "";
foreach( $recapArrayAlimentaz as $key=>$value){
    $nomeEcognome=$value[0];
    $esAlimentari=$value[1];
    ...
    $recapDatiTabellaAliment = $recapDatiTabellaAliment . $tabellaRigaA;
}
...
<h2 style='font-size: 20px; font-weight: normal; line-height:28px;color: #828340; margin-left:5%; margin-top:10%;'> Tabella con i partecipanti che hanno allergie o altre esigenze alimentari</h2>
...
<th style='padding:1%; padding-right:5%; text-align:left; width:40%;' >Nome e cognome</th>
<th style='padding:1%; padding-right:5%; text-align:left;'>Esigenza alimentare</th>
</tr>
"
.$recapDatiTabellaAliment."
 </table>
